...
export WEB_POLICY SEARCH_DEPTH WEB_CONTEXT_SIZE WEB_MAX_USES ENABLE_MODEL_WEB_TOOL_LOOP
export WEB_USE_JINA_READER
export WEB_MAX_TOOL_RESULT_CHARS AUTO_WEB_MAX_CHARS TAVILY_INCLUDE_RAW_CONTENT
export WEB_BLOCKED_DOMAINS AUTO_WEB_TIMEOUT
export ENABLE_EVAL_LOGGING EVAL_LOG_PATH EVAL_LOG_TEXT
